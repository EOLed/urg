<div class="attachmentMetadata index">
	<h2><?php __('Attachment Metadata');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $attachmentMetadatum['AttachmentMetadatum']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $attachmentMetadatum['AttachmentMetadatum']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $attachmentMetadatum['AttachmentMetadatum']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $attachmentMetadatum['AttachmentMetadatum']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
